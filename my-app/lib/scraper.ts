...
/**
 * Main scraper function with 30s timeout, retries, browser headers, and Cloudflare protection fallback.
 */
      ...
      if (typeof html === 'string') {
        if (isCloudflareOrEmptyJs(html)) {
          ...
          try {
            ...
            // Playwright fallback unavailable; return resilient metadata
            return generateResilientFallback(targetUrl);
          }
